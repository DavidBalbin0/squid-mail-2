...
import com.david.squid_mail.ui.theme.White
        ...
        Column(
            ...
            Row() {
                Icon(
                    ...
                    painter = painterResource(id = R.drawable.ic_paint), // Substitua pelo nome do seu ícone
            ...
            Row(){
                Icon(
                    ...
                    painter = painterResource(id = R.drawable.ic_user), // Substitua pelo nome do seu ícone
                    contentDescription = "Descrição do ícone", // Descrição do ícone para acessibilidade
                    tint = LogoColor,
                    modifier = Modifier.size(40.dp)
                        .padding(start = 10.dp),
            ...
            SubMenuItemSettings(title = "Alterar senha")
            SubMenuItemSettings(title = "Alterar nome")
            SubMenuItemSettings(title = "Sobre o Aplicativo")
            SubMenuItemSettings(title = "Sair")
